...
namespace GiveLove
{
    public partial class Form4 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {                
                try
                {
                    ...
                    mailclient.Credentials = new NetworkCredential("luongday123@hotmail.com", "01562218a");

                    MailMessage message = new MailMessage("luongday123@hotmail.com", "han49737@gmail.com");
                    message.Subject = "Tình yêu của tôi";
        ...
        private void Form4_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (KTCancel)
            {
                MessageBox.Show("Bạn muốn thoát thật sao?\nKhông muốn trả lời Lương à? :((", "Bạn không muốn trả lời mình à! :((", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                e.Cancel = true;
            }
        }
